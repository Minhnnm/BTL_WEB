                ...
                <form action="tai-khoan" method="post">
                    <div class="than">
                        <div class="thanh-phan">
                            ...
                            <input name="tenDn" type="text" placeholder="Nhập tên đăng nhập" required>
                        </div>
                    </div>
                    <div class="than">
                        <div class="thanh-phan">
                            <label for="email">Mật khẩu: </label>
                            <input type="text" name="mk" placeholder="Nhập mật khẩu" required></br>
                        </div>
                    </div>
                    <div class="than">
                        <div class="thanh-phan">
                            <label for="email">Tên tài khoản : </label>
                            <input type="text" class="input" name="ten" placeholder="Nhập tên tài khoản">
                        </div>
                    </div>
                    <div class="than">
                        <div class="thanh-phan">
                            <label for="email">Số điện thoại : </label>
                            <input type="text" class="input" name="sdt" placeholder="Nhập số điện thoại">
                        </div>
                    </div>
                    <div class="than">
                        <div class="thanh-phan">
                            <label for="email">Địa chỉ : </label>
                            <input type="text" class="input" name="diaChi" placeholder="Nhập địa chỉ">
                        </div>
                    </div>
                    <div class="than">
                        <div class="thanh-phan">
