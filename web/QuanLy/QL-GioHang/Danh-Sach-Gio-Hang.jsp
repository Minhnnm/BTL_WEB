            ...
            <table class="di_chuot">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Giỏ hàng của</th>
                        <th>Danh sách sản phẩm trong giỏ hàng</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <c:forEach items="${gioHangs}" var="gioHang">
                        <tr>
                            <td>GH ${gioHang.tk.id}</td>
                            <td>${gioHang.tk.tendn}</td>
                            <td>
                                <a href="gio-hang?action=danhSach&id=${gioHang.tk.id}" class="btn btn-sua">Xem danh sách</a>
                            </td>
